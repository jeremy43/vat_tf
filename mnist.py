...
tf.app.flags.DEFINE_string('data_dir', '../research/data/mnist', "")
...
def prepare_dataset_with_pate():
    ...
    file_path = 'log/mnist_query=1000.pkl'
    with open(file_path,'rb') as f:
        log = pickle.load(f)
    train_images = log['train_images']
    train_labels = log['train_labels']
    test_images = log['test_images']
    test_labels = log['test_labels']
    labeled_train_images = log['labeled_train_images']
    labeled_train_labels = log['labeled_train_labels']
